...
export const processDocument: (a: any, b: number) => [number, number, number];
export const setVaultFiles: (a: number, b: number) => void;
export const toHtml: (a: any, b: number) => [number, number, number, number];
...
export const validateWith: (a: number, b: number, c: number, d: number) => [number, number, number];
export const clearVaultFiles: () => void;
