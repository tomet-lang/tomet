...
mod tests {
    ...
    fn test_macro_pattern_and_set() {
        ...
        assert_eq!(
            set.rewrite_url("https://github.com/tomet-lang/tomet"),
            Some("$gh(\"tomet-lang/tomet\")".into())
        );
        assert_eq!(
            set.rewrite_url("https://github.com/tomet-lang/tomet/issues/42"),
            Some("$gh_issue(\"tomet-lang/tomet\", 42)".into())
        );
    }
