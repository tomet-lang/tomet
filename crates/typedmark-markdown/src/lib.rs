//! Bidirectional conversion between CommonMark and `typedmark_ast`.
//!
//! See `docs/commonmark-support.md` for the mapping this implements and
...
mod roundtrip_tests {
    ...
    /// `docs/commonmark-support.md`'s test strategy) -- the intermediate
    /// `.tm` shape doesn't have to be identical, just render the same.
